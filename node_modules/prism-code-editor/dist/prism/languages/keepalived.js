...
//#region src/prism/languages/keepalived.js
languages.keepalived = {
	...
	"ip": {
		pattern: re("\\b(?:(?:(?:[a-f\\d]{1,4}:){7}[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){6}:[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){5}:(?:[a-f\\d]{1,4}:)?[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){4}:(?:[a-f\\d]{1,4}:){0,2}[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){3}:(?:[a-f\\d]{1,4}:){0,3}[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){2}:(?:[a-f\\d]{1,4}:){0,4}[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){6}<0>|(?:[a-f\\d]{1,4}:){0,5}:<0>|::(?:[a-f\\d]{1,4}:){0,5}<0>|[a-f\\d]{1,4}::(?:[a-f\\d]{1,4}:){0,5}[a-f\\d]{1,4}|::(?:[a-f\\d]{1,4}:){0,6}[a-f\\d]{1,4}|(?:[a-f\\d]{1,4}:){1,7}:)(?:/\\d{1,3})?|<0>(?:/\\d\\d?)?)\\b", ["(?:(?:(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d)\\.){3}(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d))"], "i"),
		alias: "number"
	},
	"path": {
